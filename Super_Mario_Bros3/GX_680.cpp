...
void GX_680::GetBoundingBox(float& left, float& top, float& right, float& bottom)
{
	if (state == STATE_DIE)
		return;
	left = x;
...
void GX_680::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
...
void GX_680::SetState(int state)
{
